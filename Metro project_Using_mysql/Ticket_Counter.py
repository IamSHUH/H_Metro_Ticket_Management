...
try:
    ...
    #declaring a variable for font-style , font-size
    man =('Times',14) 
    ...
    #Adding Menu (drop down navigation) to home
    #menubar = Menu(root) 
    ...
    #creating buttons on landing page interface

    btns =  Button(root,text="GEN TICKET",bd='0',height= 2, width=15,font=man,bg='orange',fg='white',command=generate)
    ...
    btnp =  Button(root,text="SCAN TICKET",bd='0',height= 2, width=15,bg = 'Blue',fg='white',font =man, command=for_scan)
    ...
    btnq =  Button(root,text="GET HELP",bd='0',height= 2, width=15,command=Chat,bg='Green',font=man,fg='white')
    btnq.place(x=255,y=150)


    #title for window

    root.title("METRO TICKET")
    root.mainloop()
except:
    messagebox.showerror("Opps","Error Occured")